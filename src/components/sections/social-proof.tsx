    ...
    <section id="specialist" className="py-24 sm:py-32 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto">
             <h2 className="font-headline text-3xl md:text-4xl font-medium">A Especialista</h2>
        </div>
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center md:text-left bg-secondary p-8 rounded-lg shadow-md">
            ...
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
              A Dra. Reed combina uma abordagem científica rigorosa com um olhar artístico apurado para entregar resultados incomparáveis. Seu compromisso com a educação contínua nas mais recentes técnicas de odontologia digital garante que cada paciente receba o cuidado mais eficaz disponível.
            </p>
