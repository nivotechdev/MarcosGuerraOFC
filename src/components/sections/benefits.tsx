              ...
              {benefits.map((benefit, index) => (
                <CarouselItem key={index} className="pl-4 basis-11/12 sm:basis-1/2 lg:basis-1/3">
                  <div className="p-1 h-full">
                    <Card
                      className="relative text-center shadow-soft transition-all duration-300 flex flex-col group h-full bg-card rounded-2xl border-2 border-transparent hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-2 hover:z-10"
                    >
